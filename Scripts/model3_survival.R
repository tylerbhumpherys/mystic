...
kTSP_model <- loadRData("/proj/jjyehlab/users/tylerben/mystic/Models/model3_ktsp.RData")
mystic_model <- loadRData("/proj/jjyehlab/users/tylerben/mystic/Models/model3_RF.RData")
...
pdf_file <- paste(output_directory,"survivalCurve_TCGA_model",model_version,".pdf",sep="")
...
pdf_file <- paste(output_directory,"survivalCurve_Bailey_model",model_version,".pdf",sep="")
pdf(pdf_file, height = 5,width=7)
