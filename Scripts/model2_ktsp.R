...
kTSP_01042023_model2 <- SWAP.Train.KTSP(inputMat=Train_X_SSC, phenoGroup=Train_Y_SSC,classes = c("1","0"), FilterFunc=NULL, krange=c(1:10),disjoint=T)
save(kTSP_01042023_model2, file = "/proj/jjyehlab/users/tylerben/mystic/Models/model2_ktsp.RData")
