...
kTSP_model <- loadRData("/proj/jjyehlab/users/tylerben/mystic/Models/model1_ktsp.RData")
mystic_model <- loadRData("/proj/jjyehlab/users/tylerben/mystic/Models/model1_RF.RData")
