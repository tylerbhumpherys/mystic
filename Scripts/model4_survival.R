...
kTSP_model <- loadRData("/proj/jjyehlab/users/tylerben/mystic/Models/model4_ktsp.RData")
mystic_model <- loadRData("/proj/jjyehlab/users/tylerben/mystic/Models/model4_RF.RData")
